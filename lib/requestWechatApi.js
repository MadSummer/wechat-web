 ...
 * @Last Modified time: 2017-12-06 18:50:35
 */
...
const rp = requestPromise.defaults({
  ...
  simple: true,
  headers: {
    'Cookie':'last_wxuin=178051200; login_frequency=3; MM_WX_NOTIFY_STATE=1; MM_WX_SOUND_STATE=1; wxpluginkey=1512554282; wxuin=178051200; wxsid=eb6GOxaT7LMPeNC0; wxloadtime=1512557412; mm_lang=zh_CN; webwxuvid=3f90b71608b427cafb9cbb67903929827ad5106dad55f8aa84816e9c3d8ff8828481a54cc8d57fd5fb6b0ce0bec5d161; webwx_auth_ticket=CIsBEP+rhLUEGoABuKqw8jTEKdeg/ynE+kHFiTnCWstkTwEGbzwQClH9MvlnzaCxx89Opr5OQntEf30wmKF9GnxYN70KrPI0c8ORZhiyZ3VYQWLEVq3zn8BKrz03NmPjMafVNHh81w3Cj34HaZ4fAAZnNQe381tANrAKHdct4MxV1C5m6Me0NoddyVg=; webwx_data_ticket=gScxRjhqyoBekNjJbLsB4C33'
  }
});
/**
...
const updateRequestCookie = response => {
  ...
  jar = requestPromise.jar(getCookiesStore() || true);
}
updateRequestCookie();
